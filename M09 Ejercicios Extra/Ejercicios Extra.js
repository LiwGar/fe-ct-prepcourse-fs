...
function numberOfCharacters(string) {
   ...
   var resultado = Object.entries(frecuenciaLetras).sort();
   var resultadoFinal = Object.fromEntries(resultado);
...
function capToFront(string) {
   ...
   // Tu código:
   var letrasMayusculas = string.replace(/[^A-Z]/g, '');
   var letrasMinusculas = string.replace(/[^a-z]/g, '');
...
function capicua(numero) {
   ...
   var numeroInvertido = numeroComoString.split('').reverse().join('');

   if (numeroComoString === numeroInvertido) {
      return "Es capicua";
    } else {
